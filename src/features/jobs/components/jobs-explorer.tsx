...
const platformDetails: Array<{ source: string; label?: string; mark: string; description: string }> = [
  ...
  { source: "RemoteOK", mark: "RO", description: "India-eligible remote jobs" },
  { source: "Remotive", mark: "R", description: "India-eligible remote jobs" },
  { source: "Arbeitnow", mark: "AN", description: "India-filtered jobs" },
  { source: "Greenhouse", label: "Company Careers", mark: "GH", description: "India company openings" },
  { source: "Lever", label: "Company Careers", mark: "LV", description: "India company openings" },
  { source: "Career Page", label: "Company Careers", mark: "CP", description: "India direct openings" },
